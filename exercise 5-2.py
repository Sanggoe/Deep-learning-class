# -*- coding: utf-8 -*-
"""
Created on Tue May 10 11:44:27 2022
...
# 500, 1000, 5000세대까지 학습(100세대마다 학습 정보 출력)
for i in range(500): # 1000, 5000
...
'''
기존 500세대보다 세대를 1000, 5000까지 늘려서 학습했을 때,
학습의 속도는 오래 걸리지만 갈수록 오차 값이 작아지는 것을 확인할 수 있다.
또한, 당연히 그에 따른 결과값도 -1과 1의 값으로 수렴하는 것을 확인할 수 있었다.
(출력에 대해 활성함수를 적용하지 않은 값)
'''