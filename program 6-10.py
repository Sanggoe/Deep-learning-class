# -*- coding: utf-8 -*-
"""
Created on Tue Jun  7 11:00:38 2022
...
from tensorflow.keras import regularizaers
...
def cross_validation(data_gen, dropout_rate, l2_reg):
    ...
    for train_index, val_index in KFold(k).split(x_train):
        ...
        cnn.add(Dense(10, activation='softmax', kernel_regularizer=regularizaers.l2(l2_reg)))
        ...
        if data_gen:
            ...
            cnn.fit(x_train, y_train, batch_size=batch_siz, epochs=n_epoch,
                    validation_data=(x_test, y_test), verbose=2)
...
print("출력 형식: [Data augmentation-Dropout-l2 regularizer] (교차 검증 시도/평균)")
