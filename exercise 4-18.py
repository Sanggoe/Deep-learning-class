# -*- coding: utf-8 -*-
"""
Created on Mon Jun 13 15:14:18 2022
...
''' 모델 객체 생성 '''
# MLP 분류기 모델을 학습 (50, 50) / (50, 50, 50) / (50, 50, 50, 50) / (50, 50, 50, 50, 50)
mlp = MLPClassifier(hidden_layer_sizes=(50,50,50), learning_rate_init=0.001,
